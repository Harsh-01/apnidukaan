...
//                ivProfile.setImageURI(user?.profilepic?.toUri())
                    shopsRegVal.setText(user?.monthlyShops.toString())
                    distanceCoveredVal.setText(user?.monthlyDistance.toString())
                    moneyEarnedVal.setText(user?.monthlyIncome.toString())
                    timeTakenVal.setText(user?.monthlyTime.toString())
                    bonusVal.setText(user?.monthlyBonus.toString())
