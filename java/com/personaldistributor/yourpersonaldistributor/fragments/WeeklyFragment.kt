...
//                ivProfile.setImageURI(user?.profilepic?.toUri())
                    shopsRegVal.setText(user?.weeklyShops.toString())
                    distanceCoveredVal.setText(user?.weeklyDistance.toString())
                    moneyEarnedVal.setText(user?.weeklyIncome.toString())
                    timeTakenVal.setText(user?.weeklyTime.toString())
                    bonusVal.setText(user?.weeklyBonus.toString())
